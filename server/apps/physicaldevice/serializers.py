...
AVAILABLE_SENSOR_GRAPH = {
    ...
    "connector-asm-oib-v1-0-0",
    "connector-flexflow-v1-0-0",
    "connector-ipc-cfx-v1-0-0",
    "connector-panacim-v1-0-0",
    "connector-fuji-v1-0-0",
    "connector-generic-plc-v1-0-0",
    "connector-ict-keysight-v1-0-0",
    "connector-ky-kbr-v1-0-0",
    "connector-insp-cyberoptics-v1-0-0",
    "connector-insp-nordson-v1-0-0",
    "connector-insp-parmi-v1-0-0",
    "connector-insp-vitrox-v1-0-0",
    "connector-oven-heller-v1-0-0",
    "connector-printer-itw-eae-v1-0-0",
