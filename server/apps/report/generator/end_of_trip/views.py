...
class EndOfTripReportConfigureView(UserReportViewMixin, UpdateView):
    model = UserReport
    form_class = EndOfTripConfigureForm
...
class EndOfTripReportGenerateView(UserReportViewMixin, UpdateView):
    model = UserReport
    template_name = "org/form.html"
    form_class = EndOfTripReportGenerateForm
    ...
    def get_form_kwargs(self):
        kwargs = super(EndOfTripReportGenerateView, self).get_form_kwargs()
        return kwargs
